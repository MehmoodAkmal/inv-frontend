      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-neutral-200/80 dark:border-neutral-800">
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium bg-primary-50 text-primary-700 dark:bg-primary-900/60 dark:text-primary-300 border border-primary-200/60 dark:border-primary-700/50">
                Live
              </span>
            </div>
        ...
        {!isCashier && (
          <div className="flex flex-wrap gap-2">
            <Link
              to="/pos"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-600 hover:bg-primary-500 dark:bg-primary-700 dark:hover:bg-primary-600 text-white text-xs font-semibold shadow-sm transition-all duration-150 hover:shadow-md active:scale-95"
            >
            ...
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
                  ...
                  />
                  <Tooltip content={<ChartTooltip currencySymbol={currencySymbol} />} cursor={{ fill: 'rgba(14, 165, 233, 0.04)' }} />
                  <Bar
                    dataKey="cash"
                    name="Cash"
                    stackId="sales"
