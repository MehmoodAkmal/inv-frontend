...
export default function Signup() {
  ...
  const inputCls = "w-full pl-10 pr-4 py-3 text-sm text-white placeholder-white/40 rounded-xl outline-none transition-all duration-200";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10 relative overflow-hidden"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full opacity-20"
          style={{ background: "radial-gradient(circle, #3D7A7A 0%, transparent 70%)", filter: "blur(50px)" }} />
        <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full opacity-15"
          style={{ background: "radial-gradient(circle, #7DBFB2 0%, transparent 70%)", filter: "blur(40px)" }} />
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[400px] rounded-full opacity-[0.06]"
          style={{ background: "radial-gradient(circle, #3D7A7A 0%, transparent 60%)", filter: "blur(80px)" }} />
        <div className="absolute inset-0 opacity-[0.04]"
          style={{
            backgroundImage: "linear-gradient(rgba(125,191,178,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(125,191,178,0.5) 1px, transparent 1px)",
      ...
      <div className="relative w-full max-w-lg"
        style={{
          ...
          border: "1px solid rgba(125,191,178,0.15)",
          borderRadius: "24px",
          boxShadow: "0 0 0 1px rgba(125,191,178,0.08), 0 25px 50px rgba(0,18,32,0.6), inset 0 1px 0 rgba(255,255,255,0.08)",
        }}>

        <div className="absolute inset-x-0 top-0 h-px rounded-t-3xl"
          style={{ background: "linear-gradient(90deg, transparent, rgba(125,191,178,0.6), transparent)" }} />
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-7">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 relative"
              ...
              <div className="absolute inset-0 rounded-2xl"
                style={{ boxShadow: "inset 0 1px 0 rgba(255,255,255,0.25)", border: "1px solid rgba(255,255,255,0.15)" }} />
            </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="firstName" className={labelCls} style={labelStyle}>First name</label>
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={iconStyle}>
              ...
              <div>
                <label htmlFor="lastName" className={labelCls} style={labelStyle}>Last name</label>
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={iconStyle}>
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                  </div>
            ...
            {/* Organization */}
            <div>
              <label htmlFor="organizationName" className={labelCls} style={labelStyle}>Organization name</label>
              <div className="relative">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={iconStyle}>
                ...
                <input id="organizationName" name="organizationName" type="text" required
                  value={form.organizationName} onChange={handleChange} placeholder="Acme Corp"
                  className={inputCls} style={inputBase}
                  onFocus={onFocusStyle} onBlur={onBlurStyle} />
              </div>
            </div>
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className={labelCls} style={labelStyle}>Email address</label>
              <div className="relative">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={iconStyle}>
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className={labelCls} style={labelStyle}>Password</label>
              <div className="relative">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={iconStyle}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: loading ? "none" : "0 0 20px rgba(61,122,122,0.4), 0 4px 15px rgba(0,0,0,0.3)",
              }}
              onMouseEnter={e => { if (!loading) e.target.style.boxShadow = "0 0 30px rgba(61,122,122,0.6), 0 4px 20px rgba(0,0,0,0.3)"; }}
              onMouseLeave={e => { if (!loading) e.target.style.boxShadow = "0 0 20px rgba(61,122,122,0.4), 0 4px 15px rgba(0,0,0,0.3)"; }}
            >
          ...
          <p className="mt-6 text-center text-sm" style={{ color: "rgba(197,216,213,0.5)" }}>
            ...
            <Link to="/login"
              ...
              onMouseEnter={e => { e.target.style.color = "#7DBFB2"; e.target.style.textShadow = "0 0 12px rgba(125,191,178,0.5)"; }}
              onMouseLeave={e => { e.target.style.color = "rgba(125,191,178,0.9)"; e.target.style.textShadow = "none"; }}
            >
              Sign in
            </Link>
          </p>
        ...
        <div className="absolute inset-x-0 bottom-0 h-px rounded-b-3xl"
          style={{ background: "linear-gradient(90deg, transparent, rgba(61,122,122,0.3), transparent)" }} />
      </div>
    </div>
  );
}
