    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full opacity-20"
          style={{ background: "radial-gradient(circle, #3D7A7A 0%, transparent 70%)", filter: "blur(40px)" }} />
        {/* Bottom-right teal orb */}
        <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full opacity-15"
          style={{ background: "radial-gradient(circle, #7DBFB2 0%, transparent 70%)", filter: "blur(60px)" }} />
        {/* Center glow */}
