        ...
        <div className="card overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  {['Item', 'SKU', 'Branch', 'Unit', 'Current Qty', 'Reorder Level', 'Deficit'].map(
                    (h) => (
                      <th
                        key={h}
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {alerts.map((a, i) => {
                  ...
                  return (
                    <tr
                      key={i}
                      className={`${a.currentQuantity === 0 ? 'bg-red-50' : 'hover:bg-gray-50'} transition-colors`}
                    >
                      ...
                      <td className="px-5 py-3">
                        <span
                          className={`text-sm font-bold ${a.currentQuantity === 0 ? 'text-red-700' : 'text-amber-700'}`}
                        >
                          {a.currentQuantity}
                        </span>
                      </td>
