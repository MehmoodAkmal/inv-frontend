      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            ...
            <h3 className="text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-1">No sales recorded yet</h3>
            <p className="text-xs text-neutral-500 dark:text-neutral-400 max-w-xs leading-relaxed">
              No transactions match your current filter. Try a different date range or click "New Sale" to record your first transaction.
            </p>
          </div>
        ) : (
          <>
