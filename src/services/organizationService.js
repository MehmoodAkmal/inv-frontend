...
export const toggleOrganizationStatus  = (id)           => api.patch(`/admin/organizations/${id}/toggle-status`);
export const updateOrganizationPlan    = (id, data)     => api.patch(`/admin/organizations/${id}/plan`, data);
export const getSignupTrend            = (params = {})  => api.get("/admin/signup-trend", { params });
export const getMostActiveOrgs         = (params = {})  => api.get("/admin/active-organizations", { params });
