    ...
    >
      ...
      <div className="flex items-center h-16 border-b border-brand-800 shrink-0 px-3.5">
        ...
        {onClose && !collapsed && (
          <button
            onClick={onClose}
            className="ml-auto p-1 rounded hover:bg-brand-800 lg:hidden"
            aria-label="Close"
          >
            <svg
              className="w-4 h-4"
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        ...
                        <span
                          className={`shrink-0 ${isActive ? 'text-primary-400' : 'text-brand-500 group-hover:text-brand-300'} transition-colors`}
                        >
                          {item.icon}
                        </span>
